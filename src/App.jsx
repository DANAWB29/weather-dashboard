        ...
        <main className="flex flex-col md:flex-row gap-6 items-start">
          ...
          <aside className="w-full md:w-80">
            ...
            <div className="weather-card mt-6">
              ...
              <p className="text-sm text-gray-700 mt-2">This demo uses the OpenWeatherMap current weather API. To deploy, add your API key to an environment variable named <code className="bg-gray-100 px-1 rounded">62b9487a694cd0142dd7b649a6dc0131</code>.</p>
            </div>
          </aside>
        </main>
